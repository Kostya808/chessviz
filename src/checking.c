...
//пешка
    ...
    {
        if((m[n1*8 + l1].color == 1 && m[n2*8 + l2].color == 0) || (m[n1*8 + l1].color == 1 && m[n2*8 + l2].color == 0))
            if((l1 != l2) && (n1 != n2) && (((n1 + 1) == n2) || ((n1 - 1) == n2)))
                return 1;
        if (m[n2*8 + l2].color == 2)
        {
            if ((n1 == 1 && n2 < 4 && n2 > 1 && l1 == l2) || (n1 == 6 && n2 > 3 && n2 < 6 && l1 == l2))
                return 1;
            if ((m[n1*8 + l1].tip == 'p' && n1 != 6 && n2 == (n1 - 1) && l1 == l2) || (m[n1*8 + l1].tip == 'q' && n1 != 1 && n2 == (n1 + 1) && l1 ==l2))
                return 1;
        }
    }    
//слон
